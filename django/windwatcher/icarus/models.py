...
class Site(models.Model):
	...
	lat = models.DecimalField(max_digits=6, decimal_places=6) #lat and lon for the point defining the site
	lon = models.DecimalField(max_digits=6, decimal_places=6)
