...
def site_check( site , day , timelist=False):
    ...
    print site_conditions[launching_condition][landing_condition] 
...
if __name__ == "__main__":
    ...
    test_site.save()
    test_launch = Launch(name="Test Launch West",site=test_site,flyable_wind_direction_min = 220,flyable_wind_direction_max=330,flyable_wind_speed_max = 20,flyable_wind_speed_min=11)
    test_launch.save()
    test_landing = Landing(name="Test Landing West",site=test_site,flyable_wind_speed_min= 4,flyable_wind_speed_max=10,flyable_wind_direction_min=110,flyable_wind_direction_max=150)
    test_landing.save()
